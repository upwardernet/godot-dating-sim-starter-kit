...
Every push to `master` builds **Windows (.exe)**, **Linux (x86_64)**, and **Android (.apk)** via GitHub Actions. Push a `v*` tag (e.g. `v1.0.0`) to create a GitHub Release with all artifacts.
